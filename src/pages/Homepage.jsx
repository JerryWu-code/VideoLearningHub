      ...
      <div className='content'>
        <section className="bg-white dark:bg-gray-900">
          <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
            ...
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Learn Anytime, Anywhere </h1>
            ...
            <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
              ...
              <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
                ...
                <a href="https://www.google.com.hk/url?sa=t&source=web&rct=j&opi=89978449&url=http://github.com/&ved=2ahUKEwivqJ-C27aJAxXwSmwGHXxRHZcQ-TAoAHoECCsQAQ&usg=AOvVaw2c9RU0BlmsEgnwc62XUlEM" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
                  <svg class="w-[48px] h-[48px] group-hover:text-gray-800 dark:group-hover:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
